...
const buttonRows = {
    ...
    rowBattleA: (id) => {
        return new MessageActionRow().addComponents(buttons.btnFight(id), buttons.btnParty(id));
    },
    rowBattleB: (id) => {
        return new MessageActionRow().addComponents(buttons.btnItem(id), buttons.btnRun(id));
    },
    rowItem: (id) => {
        return new MessageActionRow().addComponents(buttons.btnCatch(id), buttons.btnHeal(id), buttons.btnBack(id));
    },
    rowParty: (party, id) => {
