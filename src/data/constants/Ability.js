exports.Ability = {
  ...
  "Aerilate": {
      "desc": "Normal-type moves become Flying-type moves. The power of those moves is boosted a little.",
      "name": "Aerilate"
  },
  "Aftermath": {
  ...
  "AsOne": {
      "desc": "This Ability combines the effects of both Calyrex's Unnerve Ability and Glastrier's Chilling Neigh Ability/Spectrier's Grim Neigh Ability.",
      "name": "As One"
  },
  "AuraBreak": {
  ...
  "BattleBond": {
      "desc": "Defeating an opposing Pokémon strengthens the Pokémon's bond with its Trainer, and it becomes Ash-Greninja. Water Shuriken gets more powerful.",
      "name": "Battle Bond"
  },
  "BeastBoost": {
  ...
  "DauntlessShield": {
      "desc": "Boosts the Pokémon's Defense stat when the Pokémon enters a battle.",
  ...
  "DeltaStream": {
      "desc": "The Pokémon changes the weather to eliminate all of the Flying type's weaknesses.",
      "name": "Delta Stream"
  },
  "DesolateLand": {
      "desc": "The Pokémon changes the weather to nullify Water-type attacks.",
      "name": "Desolate Land"
  },
  "Disguise": {
  ...
  "DrySkin": {
      "desc": "Restores HP in rain or when hit by Water-type moves. Reduces HP in harsh sunlight, and increases the damage received from Fire-type moves.",
      "name": "Dry Skin"
  },
  "EarlyBird": {
      "desc": "The Pokémon awakens from sleep twice as fast as other Pokémon.",
      "name": "Early Bird"
  },
  "EffectSpore": {
  ...
  "FlareBoost": {
      "desc": "Powers up special attacks when the Pokémon is burned.",
      "name": "Flare Boost"
  },
  "FlashFire": {
  ...
  "FlowerGift": {
      "desc": "Boosts the Attack and Sp. Def stats of itself and allies in harsh sunlight.",
      "name": "Flower Gift"
  },
  "FlowerVeil": {
      "desc": "Ally Grass-type Pokémon are protected from status conditions and the lowering of their stats.",
      "name": "Flower Veil"
  },
  "Fluffy": {
  ...
  "GrassPelt": {
      "desc": "Boosts the Pokémon's Defense stat on Grassy Terrain.",
      "name": "Grass Pelt"
  },
  "GrassySurge": {
  ...
  "Illuminate": {
      "desc": "Raises the likelihood of meeting wild Pokémon by illuminating the surroundings.",
      "name": "Illuminate"
  },
  "Illusion": {
  ...
  "IntrepidSword": {
      "desc": "Boosts the Pokémon's Attack stat when the Pokémon enters a battle.",
      "name": "Intrepid Sword"
  },
  "IronBarbs": {
      "desc": "Inflicts damage on the attacker upon contact with iron barbs.",
      "name": "Iron Barbs"
  },
  "IronFist": {
  ...
  "LiquidOoze": {
      "desc": "The oozed liquid has a strong stench, which damages attackers using any draining move.",
      "name": "Liquid Ooze"
  },
  "LiquidVoice": {
  ...
  "Minus": {
      "desc": "Boosts the Sp. Atk stat of the Pokémon if an ally with the Plus or Minus Ability is also in battle.",
      "name": "Minus"
  },
  "MirrorArmor": {
  ...
  "Moody": {
      "desc": "Raises one stat sharply and lowers another every turn.",
      "name": "Moody"
  },
  "MotorDrive": {
  ...
  "Multitype": {
      "desc": "Changes the Pokémon's type to match the Plate or Z-Crystal it holds.",
      "name": "Multitype"
  },
  "Mummy": {
  ...
  "PowerConstruct": {
      "desc": "Other Cells gather to aid when its HP becomes half or less. Then the Pokémon changes its form to Complete Forme.",
  ...
  "PrimordialSea": {
      "desc": "The Pokémon changes the weather to nullify Fire-type attacks.",
      "name": "Primordial Sea"
  },
  "PrismArmor": {
      "desc": "Reduces the power of supereffective attacks taken.",
  ...
  "SandVeil": {
      "desc": "Boosts the Pokémon's evasiveness in a sandstorm.",
      "name": "Sand Veil"
  },
  "SapSipper": {
  ...
  "SnowCloak": {
      "desc": "Boosts evasiveness in a hailstorm.",
      "name": "Snow Cloak"
  },
  "SnowWarning": {
  ...
  "Soundproof": {
      "desc": "Soundproofing gives the Pokémon full immunity to all sound-based moves.",
      "name": "Soundproof"
  },
  "SpeedBoost": {
  ...
  "SteamEngine": {
      "desc": "Boosts the Pokémon's Speed stat drastically if hit by a Fire- or Water-type move.",
      "name": "Steam Engine"
  },
  "Steelworker": {
  ...
  "Symbiosis": {
      "desc": "The Pokémon passes its item to an ally that has used up an item.",
      "name": "Symbiosis"
  },
  "Synchronize": {
  ...
  "TangledFeet": {
      "desc": "Raises evasiveness if the Pokémon is confused.",
      "name": "Tangled Feet"
  },
  "TanglingHair": {
      "desc": "Contact with the Pokémon lowers the attacker's Speed stat.",
  ...
  "Truant": {
      "desc": "The Pokémon can't use a move if it had used a move on the previous turn.",
      "name": "Truant"
  },
  "Turboblaze": {
      "desc": "Moves can be used on the target regardless of its Abilities.",
  ...
  "ZenMode": {
      "desc": "Changes the Pokémon's shape when HP is half or less.",
      "name": "Zen Mode"
  }
}