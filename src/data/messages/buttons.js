...
const buttons = {
    ...
    btnSelectAvatar1: new MessageButton()
        .setCustomId('selectAvatar1')
        .setStyle('PRIMARY')
        .setLabel('May'),
    btnSelectAvatar2: new MessageButton()
        .setCustomId('selectAvatar2')
        .setStyle('PRIMARY')
        .setLabel('Brendan'),
